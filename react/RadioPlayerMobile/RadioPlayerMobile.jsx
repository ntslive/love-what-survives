        ...
        return (
            <div id="radio-player-mobile" className=''>
                <div id="radio-player-handler-mobile">
                    ...
                    <div className="header__radio-player ">
                        <div className="header__radio-player__handler hidden">
                            <i id="radio-handler-icon" className="fa fa-play header-fuzzy-text header-fuzzy-text--dark"
                               aria-hidden="true"> </i>
                        ...
                        <div className="header__radio-player__text primary-font">
                            <span id="before-text" className="hidden">
                                ...
                                <div className="header-fuzzy-text header-fuzzy-text--dark">7th October 18:00</div>
                            </span>
                            <span id="during-text" className="hidden">
                            ...
                            <span id="after-text" className="hidden">
